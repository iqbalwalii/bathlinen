...
const features = [
  ...
  {
    icon: <Headphones className="w-8 h-8 mx-auto text-green-600 mb-4" />,
...
export default function FeatureBoxes() {
  return (
    <section id="choose" >
      ...
      <h1 className="text-rose-400 bg-gray-50 text-center text-2xl sm:text-4xl" >Unparalleled Craftsmanship, <br/> Unmatched Comfort, Always</h1>
